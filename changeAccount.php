...
<fieldset>
    ...
    <p>
        ...
        <input type="number" min="0" max="99999999" step=".01" class="required" name="salary" id="salary" required value="<?php echo (isset($empSalary)) ? $empSalary: ''?>"></input>
    </p>
    <p>    
        <label for="position">Position:</label>
        <input type="text" maxlength="30" class="required" name="position" id="position" required value="<?php echo (isset($empPosition)) ? $empPosition: ''?>"></input>
      </p>        
</fieldset>
